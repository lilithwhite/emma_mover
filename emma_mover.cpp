...
int main (int argc, char *argv[]){
    ...
    do
    {
        ...
        if (test == files [file_number]) {
            ...
            experimental::filesystem::copy (files [file_number], output_file, experimental::filesystem::copy_options::overwrite_existing | experimental::filesystem::copy_options::recursive);
            file_number = file_number + 1;
        }
